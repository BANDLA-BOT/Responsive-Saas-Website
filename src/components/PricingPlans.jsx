  ...
  return (
    <section id="pricing">
      <div className="max-w-7xl mx-auto px-4 mt-20 ">
        ...
        >
          <h2 className="text-3xl lg:text-5xl mt-20 tracking-tighter bg-gradient-to-t from-neutral-50 via-neutral-300 toneutr6` bg-clip-text text-transparent">
        ...
        >
          {PLANS_CONTENT.plans.map((plan, index) => (
            ...
            >
              ...
              <button className=" w-full py-3 px-4 bg-blue-600 hover:bg-blue-50 rounded-lg ">
